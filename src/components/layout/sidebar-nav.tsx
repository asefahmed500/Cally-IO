...
import { LayoutDashboard, Settings, LogOut, Briefcase, BookMarked, MessageSquare } from 'lucide-react';
          ...
          <SidebarMenuItem>
           ...
           <SidebarMenuItem>
            <Link href="/ai-assistant" passHref>
              <SidebarMenuButton asChild isActive={pathname.startsWith('/ai-assistant')} tooltip={{children: 'AI Assistant'}}>
          ...
          <SidebarMenuItem>
            <Link href="/knowledge-base" passHref>
              <SidebarMenuButton asChild isActive={pathname === '/knowledge-base'} tooltip={{children: 'Knowledge Base'}}>
                <a><BookMarked /><span>Knowledge Base</span></a>
              </SidebarMenuButton>
            </Link>
          </SidebarMenuItem>
          <SidebarMenuItem>
